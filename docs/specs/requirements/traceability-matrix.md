...
|---|---|---|---|---|---|---|
| TST-AUTH-0001 | Login endpoint returns JWT access_token with bearer type | pms-backend | `test_login_returns_token` | SYS-REQ-0001 | PASS | RUN-2026-02-16-002 |
...
| TST-PR-0003a | Create patient with demographics returns 201 with UUID and timestamps | pms-backend | `test_create_patient_success` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003b | Create patient with missing required fields returns 422 | pms-backend | `test_create_patient_missing_required_fields_returns_422` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003c | Get patient by ID returns 200 with matching demographics | pms-backend | `test_get_patient_success` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003d | Get non-existent patient returns 404 | pms-backend | `test_get_patient_not_found_returns_404` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003e | List patients returns all active patients | pms-backend | `test_list_patients_returns_created_patients` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003f | List patients on empty DB returns empty array | pms-backend | `test_list_patients_empty_returns_empty_list` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003g | Partial update changes only specified fields, refreshes updated_at | pms-backend | `test_update_patient_partial` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003h | Update non-existent patient returns 404 | pms-backend | `test_update_patient_not_found_returns_404` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003i | Deactivate patient returns 204, sets is_active=false | pms-backend | `test_deactivate_patient_success` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003j | Deactivated patient excluded from list endpoint | pms-backend | `test_deactivated_patient_excluded_from_list` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003k | Deactivate non-existent patient returns 404 | pms-backend | `test_deactivate_patient_not_found_returns_404` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0003l | POST /patients/ completes in under 2 seconds | pms-backend | `test_response_time_under_2_seconds` | SUB-PR-0003 | PASS | RUN-2026-02-16-002 |
| TST-PR-0004a | SSN not present in create response body | pms-backend | `test_create_patient_with_ssn_not_in_response` | SUB-PR-0004, SYS-REQ-0002 | PASS | RUN-2026-02-16-002 |
| TST-PR-0004b | SSN not present in get-by-ID response body | pms-backend | `test_get_patient_ssn_not_in_response` | SUB-PR-0004, SYS-REQ-0002 | PASS | RUN-2026-02-16-002 |
| TST-PR-0005 | Audit log entries created on patient access | pms-backend | — (not implemented) | SUB-PR-0005, SYS-REQ-0003 | — | — |
| TST-PR-0006a | Duplicate email on create returns 409 | pms-backend | `test_create_patient_duplicate_email_returns_409` | SUB-PR-0006 | PASS | RUN-2026-02-16-002 |
| TST-PR-0006b | Duplicate email on update returns 409 | pms-backend | `test_update_patient_duplicate_email_returns_409` | SUB-PR-0006 | PASS | RUN-2026-02-16-002 |
...
| TST-CW-0003 | Encounter list endpoint returns 200 with empty array (stub) | pms-backend | `test_list_encounters_empty` | SUB-CW-0003 | PASS | RUN-2026-02-16-002 |
...
| TST-MM-0001 | Interaction check endpoint returns 200 with empty array for unknown patient | pms-backend | `test_check_interactions_empty` | SUB-MM-0001, SYS-REQ-0006 | PASS | RUN-2026-02-16-002 |
...
| TST-MM-0008 | Medication list endpoint returns 200 with empty array (stub) | pms-backend | `test_list_medications_empty` | SUB-MM-0008 | PASS | RUN-2026-02-16-002 |
...
> **Gap Analysis:** 37 requirements lack test coverage. Priority:
> 1. **Auth/RBAC tests** — SUB-*-0001 and SUB-*-0002 (affects 4 subsystems)
> 2. **Remaining CRUD integration tests** — SUB-CW-0003 lifecycle, SUB-MM-0008 prescriptions
> 3. **Encryption/Audit tests** — SUB-PR-0005, SUB-MM-0003, SUB-MM-0004
